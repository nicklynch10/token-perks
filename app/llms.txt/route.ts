...
export async function GET() {
  ...
  const lines = [
    ...
    "Methodology v2 (Sep 7 2026): blended $/M = (3 x input + 1 x output) / 4 at list price; uncertainty labels DIRECT / EXCERPT / UNCERTAIN on every row; unverified routes are shown as unverified, never estimated from memory.",
